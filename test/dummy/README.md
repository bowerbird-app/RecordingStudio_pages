...
- Staff page composition at `/recording_studio_pages/admin/pages`. Add a section from the editor dropdown. Use a template. Edit the section list in the first column and preview enabled sections in the second. Drag sections to reorder. Copy a section from More (Recording Studio Duplicatable). Remove a page from Edit page.
