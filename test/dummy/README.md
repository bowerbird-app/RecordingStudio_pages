...
- Staff page composition at `/recording_studio_pages/admin/pages`. Add a section from the editor dropdown. Use a template. Edit the section list in a padded Card in the first column and see enabled sections in the second. Open a section to edit the form on the left and preview that section on the right. **Choose image** on hero, image-and-text, and logo items opens the Attachable picker for that section. Drag sections to reorder. Copy a section from the row’s three-dot menu (Recording Studio Duplicatable; photos come along). Remove a page from Edit page.
