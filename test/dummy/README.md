...
- Staff page composition at `/recording_studio_pages/admin/pages`. Add a section from the editor dropdown. Drag sections to reorder. Copy a section from More (Recording Studio Duplicatable).
