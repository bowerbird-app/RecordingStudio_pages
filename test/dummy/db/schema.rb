...
ActiveRecord::Schema[8.1].define(version: 2026_09_07_010006) do
  ...
  create_table "recording_studio_pages_pages", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.boolean "homepage", default: false, null: false
    t.string "template_key"
    t.string "title", null: false
    t.index ["homepage"], name: "index_recording_studio_pages_pages_on_homepage"
    t.index ["template_key"], name: "index_recording_studio_pages_pages_on_template_key"
  end

  create_table "recording_studio_pages_sections", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.jsonb "content", default: {}, null: false
    t.datetime "created_at", null: false
    t.boolean "enabled", default: true, null: false
    t.string "section_type", null: false
    t.jsonb "settings", default: {}, null: false
    t.index ["enabled"], name: "index_recording_studio_pages_sections_on_enabled"
    t.index ["section_type"], name: "index_recording_studio_pages_sections_on_section_type"
  end
