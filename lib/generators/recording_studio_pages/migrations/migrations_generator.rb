...
module RecordingStudioPages
  module Generators
    # Generator to install RecordingStudioPages migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_pages:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioPages migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioPages engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_pages_pages.rb")
